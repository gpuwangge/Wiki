...
- Served as **Geometry Model Lead** for an in-house GPU, driving geometry-pipeline modeling(Triangle assemble/setup, Clipping, Tiling, TBDR, DVS, Compression...) and integrating a texture-compression block.
